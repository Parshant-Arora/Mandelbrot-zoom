...
class BST {
 ...
 public:
  ...
  void external(TraversalType_e tt,struct Node* node);
  void left(TraversalType_e tt,struct Node* node);
  void below(TraversalType_e tt,struct Node* node);
  void right(TraversalType_e tt,struct Node* node);

  // Traverse the tree as per the given traversal type; this function must be recursive
  void traverse(TraversalType_e tt,struct Node* node);
